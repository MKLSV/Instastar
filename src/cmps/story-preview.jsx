    ...
    return <div>
        ...
        <article className="story-preview">
            ...
            <section className="story-footer">
                ...
                {likedBy.length && <section> <img src={likedBy[0].imgUrl} /><span>Liked by</span> <a className="story-likes">{likedBy[0].username}</a> {likedBy.length > 1 && <div><span>and </span><a onClick={() => likesIsOpen(likedBy)} className="story-likes">{likedBy.length - 1} others</a></div>}</section>}
